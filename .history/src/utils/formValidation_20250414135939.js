 ...
 * @param {string} username - Benutzernamen-Wert
 * @param {string} email - E-Mail-Wert
 * @param {string} password - Passwort-Wert
 * @param {string} confirmPassword - Passwort-Bestätigungswert
 ...
 * @param {string} username - Benutzernamen-Wert
 * @param {string} password - Passwort-Wert
 * @returns {Object} Objekt mit Fehlerflags
 */
