          ...
          InputProps={{
            startAdornment: (
              <InputAdornment position="start">
                <AccountCircleOutlined sx={{ color: 'rgba(255,255,255,0.6)' }} />
              </InputAdornment>
            ),
          }}
        />
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={3}>
            <Tooltip title="Passwort zurücksetzen" arrow>
              <Button component={Link} to="/reset-password" sx={{ color: 'white' }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Tooltip title="Konto entsperren" arrow>
              <Button component={Link} to="/unlock-account" sx={{ color: 'white' }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <Tooltip title="Support kontaktieren" arrow>
              <Button component={Link} to="/contact-support" sx={{ color: 'white' }}>
...
/**
 * Main Login component that handles authentication
 */
const Login = () => {
        ...
        <GlassmorphicCard>
          <Grid container>
            ...
            <Grid
              ...
              md={5}
              sx={{
                backgroundImage: 'linear-gradient(135deg, rgba(0,20,70,0.8) 0%, rgba(0,40,120,0.7) 100%)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                p: 4,
                  ...
                  <Box
                    sx={{
                      ...
                      '&::before': {
                        ...
                        bottom: -5,
                        borderRadius: '50%',
                        background: 'linear-gradient(45deg, rgba(51,102,204,0.4), rgba(94,133,222,0.1))',
                        filter: 'blur(10px)',
                        zIndex: -1,
                      },
                    }}
