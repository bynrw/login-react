...
/**
 * Shared Help and Support section that appears at the bottom of auth pages
 * @param {Object} props - Component props
 * @param {boolean} props.showUnlockAccount - Whether to show the "Unlock Account" option
 * @param {boolean} props.showBackToLogin - Whether to show the "Back to Login" option
 */
