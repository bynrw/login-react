...
/**
 * Login-Formular-Komponente mit Benutzername- und Passwort-Eingabe
 */
const LoginForm = ({
  onSubmit,
  onInputChange,
  ...
  return (
    <Fade in timeout={1000}>
      <Box sx={{ animation: `${fadeIn} 0.6s ease-out` }}>
        {/* Warnung nach fehlgeschlagenen Login-Versuchen */}
        {showLockWarning && (
        ...
        <Box component="form" onSubmit={onSubmit} noValidate>
          ...
          {/* Passwort-Feld mit Umschaltmöglichkeit für die Sichtbarkeit */}
          <StyledTextField
            fullWidth
            label="Passwort"
            name="password"
